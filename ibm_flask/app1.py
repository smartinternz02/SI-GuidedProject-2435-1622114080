...
API_KEY = "6ULCZMq8TzcS1q-svWs6XYqKKc6YG0BMXgVM766s1aSZ"
...
def index():
    ...
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/609fd298-99f0-4d25-b293-23a06736ff4a/predictions?version=2021-06-07', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
